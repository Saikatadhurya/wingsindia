...
if(isset($_POST['update']))
{
	...
	else
	{
		...
		$update_query="update sub4audioxeno set id = '$uniqueid', cname = '$cname', sname = '$sname', audio = '$audioid', date = '$date', pname = '$pname', place = '$place', district = '$district', description = '$description', postedby = '$user_name' where id = '$update_id'";
