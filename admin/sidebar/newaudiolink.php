	...
	else
	{
		...
		$result = mysqli_query($db, $check_query);
		  ...
		  $check1 = mysqli_fetch_assoc($result1);
			...
			$query = "INSERT INTO sub4audioxeno (id,cname,sname,audio,date,pname,place,district,description,postedby) VALUES('$uniqueid','$cname','$sname','$audioid','$date','$pname','$place','$district','$description','$user_name')";
