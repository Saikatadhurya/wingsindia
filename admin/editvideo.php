...
if(isset($_POST['update']))
{
	...
	else
	{
		...
		$update_query="update sub4video set id = '$uniqueid', cname = '$cname', sname = '$sname', video = '$videoid', date = '$date', pname = '$pname', place = '$place', district = '$district', description = '$description', postedby = '$user_name' where id = '$update_id'";
