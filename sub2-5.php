...
<html lang="en">
  <head>
    ...
    <title>WINGS India | <?php echo $page_sub2; ?> </title>
  </head>
  <body>
...
<div id="containerR">
<?php  $query = mysqli_query($db,"select * from sub25 where sub2='$page_sub2'");
		$rows = mysqli_fetch_assoc($query);
		$sub2 = $rows['sub2'];
		?>
		<h1 id="<?php echo $sub2; ?>"><b><u><?php echo "$sub2"; ?></u></b></h1><br>
	...
	<div class="row">
		...
		$description = $row1['description'];
		 ?>
				   <div class="col-lg-4">
				   <a href="sub3.php?sub2=<?php echo $sub21; ?>&sub25=<?php echo $name1; ?>#<?php echo $name1; ?>" > <img class="rounded-circle" src="assets/image/<?php echo "$image"; ?>" alt="Generic placeholder image" width="140" height="140" title="wildwingsindia"></a>
					<h3 style="text-align:left;"><?php echo "$name1"; ?></h3>
					<p><?php echo "$description"; ?></p>
					<p><a class="btn btn-secondary" href="sub3.php?sub2=<?php echo $sub2; ?>&sub25=<?php echo $name1; ?>" role="button">View details &raquo;</a></p>
				  </div><!-- /.col-lg-4 -->
