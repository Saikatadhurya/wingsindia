...
<div id="container">
	<?php include("includes/connect.php");
		$page_sname = $_POST['sname'];
		$page_cname = $_POST['cname'];
		$query = mysqli_query($db,"select * from sub4name where sname='$page_sname' AND cname='$page_cname'");
...
<?php	
		...
		<div id="<?php echo $page_cname ?>">
		   <a href="description.php?name=<?php echo $page_cname; ?>"><h3><b><?php echo "$page_cname"; ?></b></a> <i><?php echo "$page_sname"; ?></i></h3>
			<h6><b>Local Name:</b> <?php echo "$lname"; ?></h6>
					<hr>
			<h4><b>Images:</b></h4>
			<div class="row">
		<?php 	
		$query1 = mysqli_query($db,"select * from sub4 where sname='$page_sname' AND cname='$page_cname'");
		...
		?>
			...
			<p><b><?php echo "$description"; ?></b></p> 	
			 <a href="assets/image/<?php echo $image;?>" data-toggle="lightbox" data-gallery="example-gallery" data-title="<?php echo $page_cname; ?>(<i><?php echo $page_sname; ?></i>) <?php echo $id; ?>" data-footer="© <?php echo $pname;?>, <?php echo $place;?> <?php echo $date;?>">
		...
		?>
			...
			<div class="row">
			<?php
			$query2 = mysqli_query($db,"select * from sub4video where sname='$page_sname' AND cname='$page_cname'");
			...
			<div class="row">
			<?php
			$query3 = mysqli_query($db,"select * from sub4audioxeno where sname='$page_sname' AND cname='$page_cname'");
