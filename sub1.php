...
<html lang="en">
  <head>
    ...
    <title>WINGS India | <?php echo $page_kingdom; ?></title>
  </head>
  <body>
...
$description = $row['description'];
 ?>
			<div class="col-lg-4">
           <a href="sub2.php?sub1=<?php echo $name; ?>" > <img class="rounded-circle" src="assets/image/<?php echo "$image"; ?>" alt="Generic placeholder image" width="140" height="140" title="wildwingsindia"></a>
