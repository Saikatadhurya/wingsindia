  ...
  <a class="navbar-brand" href="index.php"><img src="assets/image/logo.jpg" id="logo" alt="wingsindialogo"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
	...
	<li class="nav-item dropdown">
	 ...
	 <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="wildbengal.php" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="#">Our Work</a>
			  ...
			  <div class="searchbar">
		<input type="text" id="search" placeholder="Search species"class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default"><br>
